...
#
#     @skipUnless(
#         lambda x: "BARE_METAL" in x.SUPPORTED_ENVS, "Bare metal environment is required"
#     )
#     def test_bare_metal(self):
#         pass
#
#     @skipIf(lambda x: getattr(x, "MEMORY", 0) < 4096, "Not enough memory for test")
#     def test_large_memory(self):
#         pass
#
#     @skipUnless(
#         lambda x: "VIRTUAL_MACHINE" in x.SUPPORTED_ENVS,
...
#
#     @skipUnless(
#         lambda x: "CONTAINER" in x.SUPPORTED_ENVS, "Container environment is required"
#     )
