...
class LinuxBuildTest(Test):
    ...
    def setUp(self):
        kernel_src_url = self.params.get(
            "linux_src_url", default="https://www.kernel.org/pub/linux/kernel/v5.x/"
        )
        ...
        self.linux_build = kernel.KernelBuild(
            kernel_version, linux_config, self.workdir, self.cache_dirs
        )
